...
async function requestReward() {
  ...
  if (profile.green_points < 3) {
    alert(
      'You need at least 3 Green Points.'
    );
    return;
  }
  ...
  if (pendingRequest) {
    alert(
      'You already have a pending reward request.'
    );
    return;
  }
  ...
  try {
    ...
    if (!result?.success) {
      alert(
        result?.message ||
          'Could not create reward request.'
      );
    ...
    alert(
      'Reward request sent successfully!'
    );
    ...
    alert(
      'Something went wrong while requesting the reward.'
    );
...
async function copyReferralCode() {
  ...
  try {
    ...
    alert(
      'Could not copy the referral code.'
    );
  }
}
...
<section className="mt-6 bg-[#143640] rounded-2xl shadow-lg p-6 text-white">
  ...
  <div className="flex items-center gap-3 mb-2">
    ...
    <div className="w-11 h-11 rounded-xl bg-[#E7B548] text-[#143640] flex items-center justify-center">
      <FaUsers />
    </div>
    ...
    <div>
      ...
      <p className="text-white/70 text-sm">
        Invite friends and earn Green Points.
      </p>
  ...
  <div className="mt-6">
    ...
    <div className="flex flex-col sm:flex-row gap-3">
      ...
      <div className="flex-1 bg-white text-[#143640] font-bold text-lg px-5 py-3 rounded-lg tracking-wider">
        {profile.referral_code}
      </div>

      <button
        onClick={copyReferralCode}
        className="flex items-center justify-center gap-2 bg-[#E7B548] text-[#143640] font-bold px-5 py-3 rounded-lg hover:opacity-90 transition"
      >
  ...
  <div className="mt-5">
    ...
    <div className="flex flex-col sm:flex-row gap-3">
      ...
      <div className="flex-1 bg-white/10 border border-white/20 text-white px-4 py-3 rounded-lg text-sm break-all">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 bg-white text-[#143640] font-bold px-5 py-3 rounded-lg hover:bg-gray-100 transition"
      >
  ...
  <button
    ...
    className="w-full mt-5 flex items-center justify-center gap-2 bg-green-600 text-white font-bold px-5 py-3 rounded-lg hover:bg-green-700 transition"
  >
  ...
  <div className="mt-6 pt-5 border-t border-white/10 grid grid-cols-2 gap-4">
    ...
    <div className="bg-white/5 rounded-xl p-4">
      ...
      <p className="text-2xl font-bold text-[#E7B548] mt-1">
...
<section className="mt-8 bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
  ...
  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
    ...
    <div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="w-11 h-11 rounded-xl bg-[#143640] text-[#E7B548] flex items-center justify-center">
    ...
    <div className="bg-[#143640] text-white px-5 py-3 rounded-xl">
    ...
    <div className="space-y-3">
      ...
      {referrals.map(
        (referral, index) => (
          ...
          <div
            key={referral.id}
            className="flex items-center justify-between gap-4 border border-gray-200 rounded-xl p-4 hover:shadow-sm transition"
          >

            <div className="flex items-center gap-4">

              <div className="w-10 h-10 rounded-full bg-[#143640] text-[#E7B548] flex items-center justify-center font-bold">
  ...
  {referral.referred_user?.[0]?.full_name || 'New User'}
</p>

<p className="text-sm text-gray-500">
  {referral.referred_user?.[0]?.email || 'Email not available'}
</p>
